...
class TestDrupal8QcmController extends ControllerBase {
  ...
  # Template de la page "résultat du test".
	public function result($test_theme = null, $test_score = null){
    $build = array(
      '#theme' => 'test_d8_result',
  ...
  # Surcharge du titre de la page "résultat du test".
  public function getResultTitle($test_theme = null, $test_score = null){
    return 'Test ' . $test_theme;
  }
